...
public class ZB8CodeInfo {
    ...
    public static int CODE_FAILURE_TOKEN = 2003; // 获取token失败
    ...
    public static int CODE_GOODS_INFO_FAILURE = 4003;//获取订单信息失败


    public static String MSG_INSTALL_LATEST_ZHIBO8 = "请安装最新版本直播吧";
    ...
    public static String MSG_GOODS_INFO_FAILURE = "获取订单信息失败";
    public static String MSG_FAILURE_TOKEN = "获取token失败";
